...
const movie8 = new movie(7, "Greaterererer Grandson of the Mask", 2071, -0.6);
const movie6 = new movie(7, "Greatererererer Grandson of the Mask", 2082, -1.2);
const movie2 = new movie(7, "Greaterererererer Grandson of the Mask", 2093, -5.0);
